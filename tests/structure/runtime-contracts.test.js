...
const CONTRACT_CATEGORIES = new Map([
  ...
  ['memory.getOverview', 'memory'],
  ['memory.getWorkStatus', 'memory'],
  ['memory.auditHistoryIndex', 'memory'],
  ['memory.grantHistoryRecallConsent', 'memory'],
  ['memory.invalidateConversation', 'memory'],
  ['memory.optimizeHistoryIndex', 'memory'],
  ['memory.retrieveHistory', 'memory'],
  ['memory.rebuildHistoryIndex', 'memory'],
  ['memory.refreshOverview', 'memory'],
  ['memory.revokeHistoryRecallConsent', 'memory'],
  ['memory.updateSummary', 'memory'],

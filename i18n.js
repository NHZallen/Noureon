window.i18n = {
    'zh-TW': {
        ...
        versionNumber: 'Astra-nos-16.4.4', // Updated
        ...
        model_gemini_2_5_flash_pv_desc_tier_paid: '百萬輸入/0.30$、百萬輸出/2.50$',
        model_gemini_2_5_flash_desc_tier_free: '費用-免費 (10次/分鐘、250次/天)',
        model_gemini_2_5_flash_desc_tier_paid: '百萬輸入/0.30$、百萬輸出/2.50$',
        model_gemini_2_5_flash_lite_pv_desc_tier_free: '費用-免費 (15次/分鐘、1000次/天)',
        model_gemini_2_5_flash_lite_pv_desc_tier_paid: '百萬輸入/0.10$、百萬輸出/0.40$',
        model_gemini_3_pro_preview_desc_tier_free: '不提供',
        model_gemini_3_pro_preview_desc_tier_paid: '百萬輸入/2$、百萬輸出/12$、圖片/0.008$',
        // OpenRouter Free
        ...
        model_tng_r1t_chimera_desc_tier_paid: '不提供',
        model_nemotron_nano_12b_v2_vl_desc_tier_free: '費用-免費 (20次/分鐘、50次/天)',
        model_nemotron_nano_12b_v2_vl_desc_tier_paid: '不提供',
        model_nova_2_lite_v1_desc_tier_free: '費用-免費',
        model_nova_2_lite_v1_desc_tier_paid: '不提供',
        model_devstral_2512_desc_tier_free: '費用-免費',
        model_devstral_2512_desc_tier_paid: '不提供',
        // OpenAI Paid
        model_gpt_5_2_pro_desc_tier_free: '不提供',
        model_gpt_5_2_pro_desc_tier_paid: '百萬輸入/21$、百萬輸出/168$',
        model_gpt_5_2_desc_tier_free: '不提供',
        ...
        model_gpt_5_1_codex_desc_tier_free: '不提供',
        model_gpt_5_1_codex_desc_tier_paid: '百萬輸入/1.25$、百萬輸出/10$',
        // Anthropic Paid
        model_claude_opus_4_5_desc_tier_free: '不提供',
        ...
        // x-ai Paid
        model_grok_4_1_fast_desc_tier_free: '不提供',
        ...
        model_qwen3_coder_exact_desc_tier_free: '不提供',
        ...
        model_qwen3_next_80b_desc_tier_free: '不提供',
        ...
        model_qwen3_vl_30b_desc_tier_free: '不提供',
        model_qwen3_vl_30b_desc_tier_paid: '百萬輸入/0.15$、百萬輸出/0.60$',
        model_deepseek_v3_2_desc_tier_free: '不提供',
    ...
    'en': {
        ...
        importDataDesc: 'Select a previously exported `.json` or `.zip` file. All current data will be overwritten.', // Updated
        ...
        importDataDescAuth: 'Select a previously exported `.json` or `.zip` file. The username and password you enter will be used to verify ownership of the backup file.', // Updated
        ...
        model_gemini_2_5_flash_pv_desc_tier_paid: '$0.30/M input, $2.50/M output',
        model_gemini_2_5_flash_desc_tier_free: 'Cost - Free (10 req/min, 250 req/day)',
        model_gemini_2_5_flash_desc_tier_paid: '$0.30/M input, $2.50/M output',
        model_gemini_2_5_flash_lite_pv_desc_tier_free: 'Cost - Free (15 req/min, 1000 req/day)',
        model_gemini_2_5_flash_lite_pv_desc_tier_paid: '$0.10/M input, $0.40/M output',
        model_gemini_3_pro_preview_desc_tier_free: 'Not available',
        model_gemini_3_pro_preview_desc_tier_paid: '$2/M input, $12/M output, $0.008/img',
        ...
        model_tng_r1t_chimera_desc_tier_paid: 'Not available',
        model_nemotron_nano_12b_v2_vl_desc_tier_free: 'Cost - Free (20 req/min, 50 req/day)',
        model_nemotron_nano_12b_v2_vl_desc_tier_paid: 'Not available',
        model_nova_2_lite_v1_desc_tier_free: 'Cost - Free',
        model_nova_2_lite_v1_desc_tier_paid: 'Not available',
        model_devstral_2512_desc_tier_free: 'Cost - Free',
        model_devstral_2512_desc_tier_paid: 'Not available',
        model_gpt_5_2_pro_desc_tier_free: 'Not available',
        model_gpt_5_2_pro_desc_tier_paid: '$21/M input, $168/M output',
        model_gpt_5_2_desc_tier_free: 'Not available',
        ...
        model_gpt_5_1_codex_desc_tier_free: 'Not available',
        model_gpt_5_1_codex_desc_tier_paid: '$1.25/M input, $10/M output',
        model_claude_opus_4_5_desc_tier_free: 'Not available',
        ...
        model_grok_4_1_fast_desc_tier_free: 'Not available',
        ...
        model_qwen3_coder_exact_desc_tier_free: 'Not available',
        model_qwen3_coder_exact_desc_tier_paid: '$0.22/M input, $1.80/M output',
        model_qwen3_next_80b_desc_tier_free: 'Not available',
        ...
        model_qwen3_vl_30b_desc_tier_free: 'Not available',
        model_qwen3_vl_30b_desc_tier_paid: '$0.15/M input, $0.60/M output',
        model_deepseek_v3_2_desc_tier_free: 'Not available',
    ...
    'fr': {
        ...
        importDataDesc: 'Sélectionnez un fichier `.json` ou `.zip` précédemment exporté. Toutes les données actuelles seront écrasées.', // Updated
        ...
        importDataDescAuth: 'Sélectionnez un fichier `.json` ou `.zip` précédemment exporté. Le nom d\'utilisateur et le mot de passe que vous saisissez seront utilisés pour vérifier la propriété du fichier de sauvegarde.', // Updated
        ...
        model_gemini_2_5_flash_pv_desc_tier_paid: '0.30 $/M entrée, 2.50 $/M sortie',
        model_gemini_2_5_flash_desc_tier_free: 'Coût - Gratuit (10 req/min, 250 req/jour)',
        model_gemini_2_5_flash_desc_tier_paid: '0.30 $/M entrée, 2.50 $/M sortie',
        model_gemini_2_5_flash_lite_pv_desc_tier_free: 'Coût - Gratuit (15 req/min, 1000 req/jour)',
        model_gemini_2_5_flash_lite_pv_desc_tier_paid: '0.10 $/M entrée, 0.40 $/M sortie',
        ...
        model_tng_r1t_chimera_desc_tier_paid: 'Non disponible',
        model_nemotron_nano_12b_v2_vl_desc_tier_free: 'Coût - Gratuit (20 req/min, 50 req/jour)',
        model_nemotron_nano_12b_v2_vl_desc_tier_paid: 'Non disponible',
        model_nova_2_lite_v1_desc_tier_free: 'Coût - Gratuit',
        model_nova_2_lite_v1_desc_tier_paid: 'Non disponible',
        model_devstral_2512_desc_tier_free: 'Coût - Gratuit',
        model_devstral_2512_desc_tier_paid: 'Non disponible',
        model_gpt_5_2_pro_desc_tier_free: 'Non disponible',
        model_gpt_5_2_pro_desc_tier_paid: '21 $/M entrée, 168 $/M sortie',
        model_gpt_5_2_desc_tier_free: 'Non disponible',
        ...
        model_gpt_5_1_codex_desc_tier_free: 'Non disponible',
        model_gpt_5_1_codex_desc_tier_paid: '1,25 $/M entrée, 10 $/M sortie',
        model_claude_opus_4_5_desc_tier_free: 'Non disponible',
        ...
        model_grok_4_1_fast_desc_tier_free: 'Non disponible',
        ...
        model_qwen3_coder_exact_desc_tier_free: 'Non disponible',
        model_qwen3_coder_exact_desc_tier_paid: '0,22 $/M entrée, 1,80 $/M sortie',
        model_qwen3_next_80b_desc_tier_free: 'Non disponible',
        ...
        model_qwen3_vl_30b_desc_tier_free: 'Non disponible',
        model_qwen3_vl_30b_desc_tier_paid: '0,15 $/M entrée, 0,60 $/M sortie',
        model_deepseek_v3_2_desc_tier_free: 'Non disponible',

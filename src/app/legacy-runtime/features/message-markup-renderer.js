            ...
            userActionButtons = `
                <div class="user-message-actions" aria-label="訊息操作">
                    <button type="button" class="user-message-action" data-message-action="copy" title="複製訊息" aria-label="複製訊息">
                        <svg aria-hidden="true" viewBox="0 0 24 24" fill="none" stroke="#6b7280" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="8" width="13" height="13" rx="2"></rect><rect x="8" y="3" width="13" height="13" rx="2"></rect></svg>
                    </button>

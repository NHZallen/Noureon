...
const sanitizeTrustedHTML = createTrustedHtmlSanitizer({ sanitizer: DOMPurify });
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        const FOLDER_COLORS = { black: '#000000', gray: '#808080', red: '#f87171', yellow: '#facc15', green: '#4ade80', blue: '#60a5fa', indigo: '#818cf8', purple: '#a78bfa', pink: '#f472b6', orange: '#fb923c', amber: '#fbbf24', lime: '#a3e635', emerald: '#34d399', teal: '#2dd4bf', cyan: '#22d3ee', rose: '#fb7185' };

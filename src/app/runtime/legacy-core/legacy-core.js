        ...
        const getModelPriceLabel = (model) => {
            ...
            if (uiLanguage === 'fr') {
                return {
                    ...
                    skipped: 'ignoré',
                    noVisionParticipants: 'Au moins un modèle participant doit prendre en charge les images pour cette demande du conseil',
                    skippedVisualReason: 'Ignoré car ce modèle ne prend pas en charge l’image ou la vidéo jointe',
                    sharedSearch: 'Dossier de recherche partagé',
                    searchRunning: 'Recherche unique pour le contexte partagé du conseil',
                    ...
                    synthesis: 'Le synthétiseur combine les réponses du conseil',
                    ...
                    activeVisionNote: 'Seuls les membres compatibles avec les images répondront à cette demande.',
                    comparisonToggle: 'Résumer les accords et les différences',
                    retrying: 'Nouvelle tentative',
                    councilLocked: 'Le conseil répond ; les paramètres sont verrouillés jusqu’à la fin.',
                    searchManualNotice: 'Le mode conseil n’active pas la recherche automatiquement. Activez Recherche avant l’envoi si cette question nécessite des informations web récentes.',
                    searchEnabledNote: 'Recherche activée : le conseil utilisera un dossier de recherche partagé.'
                };
            }
            return {
                visualOnly: '視覺參與模型',
                ...
                skippedVisualReason: '此模型不支援附加的圖片或影片，因此略過',
                sharedSearch: '共用搜尋資料包',
                searchRunning: '正在為理事會進行一次共用搜尋',
                searchDone: '共用搜尋資料包已就緒',
                searchFailed: '共用搜尋失敗，將不使用搜尋繼續',
                firstRound: '理事會成員正在思考',
                deliberation: '理事會成員正在修訂',
                synthesis: '統整模型正在整理理事會結果',
                completed: '理事會完成',
                pending: '等待中',
                running: '思考中',
                done: '完成',
                failed: '失敗',
                skippedStatus: '已略過',
                activeVisionNote: '這次圖片請求只會由支援圖片的成員回答。',
                comparisonToggle: '總結共識與差異',
                retrying: '正在重試一次',
                councilLocked: '理事會正在回覆；完成前會鎖定設定。',
                searchManualNotice: '理事會模式不會自動啟用搜尋。若問題需要最新網路資訊，請先開啟搜尋再送出。',
                searchEnabledNote: '搜尋已開啟：理事會將使用一份共用搜尋資料包。'
            };
        };

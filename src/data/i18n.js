window.i18n = {
    'zh-TW': {
        ...
        councilTranslatorModel: '理事會轉譯模型',
        councilTranslatorModelDesc: '只用於把附件詳細轉譯成文字包，不參與理事會投票或回答；此清單只顯示同時支援視覺與文件上傳的模型。',
        ...
        singleSearchTranslatorModel: '單模型搜索轉譯模型',
        singleSearchTranslatorModelDesc: '提供給不支援搜索的單一模型，先整理一份詳細搜索脈絡。',
        ...
        appSettings: '應用程式設定',
        exportApiKeys: 'API 金鑰 (Gemini、OpenRouter 和 NVIDIA)',
    ...
    'en': {
        ...
        councilTranslatorModel: 'Council Translator Model',
        councilTranslatorModelDesc: 'Only translates attachments into detailed text packets for the council. It does not vote or answer, and this list only shows models that support both vision and file upload.',
        ...
        singleSearchTranslatorModel: 'Single-model search translator',
        singleSearchTranslatorModelDesc: 'For models without native search. It creates a detailed research packet before the answer.',
    ...
    'fr': {
        ...
        councilTranslatorModel: 'Modèle traducteur du conseil',
        councilTranslatorModelDesc: 'Traduit seulement les pièces jointes en paquets texte détaillés pour le conseil. Il ne vote pas et ne répond pas; cette liste affiche uniquement les modèles qui prennent en charge la vision et les fichiers.',
        ...
        singleSearchTranslatorModel: 'Traducteur de recherche',
        singleSearchTranslatorModelDesc: 'Pour les modèles sans recherche native. Crée un paquet de recherche détaillé avant la réponse.',

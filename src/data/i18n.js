window.i18n = {
    'zh-TW': {
        ...
        councilTranslatorModelDesc: '用於把附件或理事會搜索結果轉成共用資料包，不參與理事會投票或回答；此清單只顯示同時支援視覺與文件上傳的模型。',
    ...
    'en': {
        ...
        councilTranslatorModelDesc: 'Translates attachments or council search results into shared packets. It does not vote or answer, and this list only shows models that support both vision and file upload.',
    ...
    'fr': {
        ...
        councilTranslatorModelDesc: 'Traduit les pièces jointes ou les résultats de recherche du conseil en paquets partagés. Il ne vote pas et ne répond pas; cette liste affiche uniquement les modèles qui prennent en charge la vision et les fichiers.',

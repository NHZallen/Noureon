const en = {
        ...
        cloudLoginRegister: 'Login / Create account',
        forgotPassword: 'Forgot password?',
        authDividerOr: 'or',
        supabaseGoogleLogin: 'Sign in with Google',
        localModeEntry: 'Use legacy local login / import',
        localModeReturn: 'Back to Email / Google login',
        importLocalRecords: 'Import legacy records',
        localAccountLabel: 'Legacy account / local name',
        localUsernamePlaceholder: 'Enter legacy account or local name',
        localPasswordPlaceholder: 'Legacy password or new local password',
        localLoginRegister: 'Login / register local account',
        localImportLogin: 'Login and finish import',
        ...
        cloudAuthMissingFields: 'Enter an Email address and a password with at least 8 characters.',
        cloudAuthSigningIn: 'Signing in. If the account does not exist, it will be created...',
        cloudAuthCheckEmail: 'Account created. Check your inbox to verify your Email, then sign in.',
        cloudModeReturned: 'Returned to Email / Google login.',
        localModeHint: 'Enter your legacy account password, or import a legacy backup here.',
        importCredentialsHint: 'Enter the legacy account password. After import, it will be linked to the current cloud account.',
        cloudImportPasswordHint: 'Enter the legacy account password; the legacy data will be imported after login.',
        cloudLoginImportConfirm: 'Import legacy local data into this cloud account?',
        recoveryReady: 'Set your new login password.',
        turnstileRequired: 'Complete verification first.',
        turnstileInitFailed: 'Verification failed to load. Refresh and try again.',
        passwordResetSent: 'Password reset email sent. Check your inbox.',
        passwordResetUpdated: 'Password updated. Sign in with the new password.',
        passwordResetMismatch: 'Both passwords must match and contain at least 8 characters.',
        passwordRecoveryPageTitle: 'Reset password · Noureon',
        passwordResetPageTitle: 'Set a new password · Noureon',
        passwordRecoveryTitle: 'Reset your password',
        passwordRecoveryDescription: 'Enter the Email linked to your account and we will send an 8-digit verification code.',
        passwordRecoverySendCode: 'Send verification code',
        passwordRecoveryCodeSent: 'If this Email is linked to an account, a code has been sent. Check your inbox and spam folder.',
        passwordRecoveryCodeLabel: '8-digit verification code',
        passwordRecoveryVerifyCode: 'Verify and continue',
        passwordRecoveryRequestAnother: 'Request another code',
        passwordRecoveryResendCountdown: 'Resend in {seconds}s',
        passwordRecoveryBackToLogin: 'Back to sign in',
        passwordRecoveryEmailInvalid: 'Enter a valid Email address.',
        passwordRecoverySendFailed: 'We could not send a verification code. Try again later.',
        passwordRecoveryCodeInvalidFormat: 'Enter the 8-digit verification code.',
        passwordRecoveryCodeInvalid: 'The code is incorrect or has expired. Check it and try again.',
        passwordResetChecking: 'Checking verification status…',
        passwordResetVerificationRequiredTitle: 'Verify your Email first',
        passwordResetVerificationRequired: 'To reset your password, enter your Email and verify the code sent to you first.',
        passwordResetVerificationExpired: 'This verification has expired. Request a new code.',
        passwordResetVerificationUnavailable: 'We could not confirm this verification. Request a new code.',
        passwordResetStart: 'Start password reset',
        passwordResetNewTitle: 'Set a new password',
        passwordResetNewDescription: 'Create a new login password with at least 8 characters.',
        passwordResetNewLabel: 'New password',
        passwordResetConfirmLabel: 'Confirm new password',
        passwordResetTooShort: 'The new password must contain at least 8 characters.',
        passwordResetMismatchOnly: 'The two new passwords do not match.',
        passwordResetUpdateFailed: 'We could not update your password. Request a new code and try again.',
        username: 'Username',
        ...
        // Main App UI
        newChat: 'New Chat',
        temporaryChatStart: 'Start temporary chat',
        temporaryChatExit: 'Exit temporary chat',
        temporaryChatTitle: 'Temporary chat',
        temporaryChatDescription: 'This chat can reference existing memories, but it will not appear in your chat history or create new memories.',
        temporaryChatPersonalized: 'Personalized',
        ...
        quoteInquiryRemove: 'Remove quote',
        quoteInquiryReferenceLabel: 'Selected passage',
        quoteInquiryQuestionLabel: 'User follow-up',
        quoteInquiryContextInstruction: 'The user is asking about a selected passage from your earlier reply. Treat it as part of your earlier reply, use the full conversation context, and answer the user directly. Do not mention the quote mechanism, selected text, or source of the answer.',
        quoteInquiryDefaultQuestion: 'Explain the relevant meaning or provide direct assistance.',
        voiceInput: 'Voice Input',
        webSearch: 'Search',
        learning: 'Learning',
        image: 'Image',
        cameraDescription: 'Capture an image with this device',
        imageDescription: 'Upload images or videos',
        fileDescription: 'Upload documents and other files',
        webSearchDescription: 'Find current information online',
        learningDescription: 'Learn with guided explanations',
        modelCouncilDescription: 'Analyze with multiple models',
        ...
        dialogInputPlaceholder: 'Enter here…',
        historyRecallTitle: 'Cross-conversation recall',
        historyRecallDescription: 'When enabled, this device sends the current question to Gemini Embedding 2 and uses a local index to find up to three relevant summaries from earlier conversations. Sources are not shown in the chat.',
        historyRecallBuildIndex: 'Build complete local index',
        historyRecallAuditIndex: 'Check local index',
        ...
        historyRecallStatusLoading: 'Loading this device’s local index…',
        historyRecallProgress: 'Scanned {completed}/{total} conversations ({percentage}%)',
        historyRecallStatusBuilding: 'Checking the local index: scanned {completed}/{total} conversations. Missing or outdated items are repaired automatically.',
        historyRecallStatusComplete: 'Index check complete: scanned {completed}/{total} conversations ({indexed} repaired, {skipped} already current, {failed} failed).',
        historyRecallStatusIncomplete: 'Index check incomplete: scanned {completed}/{total} conversations ({indexed} repaired, {skipped} already current, {failed} failed).',
        ...
        exportApiKeysPasswordTitle: 'Unlock API key export',
        exportApiKeysPasswordPrompt: 'Enter your sync password to encrypt the API keys in this backup.',
        importApiKeysPasswordTitle: 'Unlock API keys',
        importApiKeysPasswordPrompt: 'Enter the sync password used when this backup was created.',
        ...
        highRiskNourasWarning: 'This Nouras may involve a high-risk professional role in mental health, medicine, law, or finance. Noureon does not verify its qualifications; it can only provide general information and organization, not replace qualified human help.',
        ...
        voiceErrorNotAllowed: 'Microphone access was blocked. Allow this site to use your microphone in your browser settings, then try again.',
        voiceErrorNoSpeech: 'No speech was detected. Try speaking again, or type instead.',
        voiceErrorAborted: 'Voice input was cancelled.',
        voiceErrorAudioCapture: 'No microphone was found. Check that a microphone is connected.',
        voiceErrorNetwork: 'The speech recognition service could not be reached. Check your connection and try again.',
        voiceErrorLanguageUnsupported: 'Your browser does not support speech recognition for the current interface language. Typing and search still work as usual.',
        voicePrivacyNoticeTitle: 'About voice input',
        voicePrivacyNoticeBody: 'Voice input is transcribed by your browser, which may pass the audio to your operating system or an online speech service. Noureon does not keep a separate recording. Start using it?',
        ...
        astras_official_editor_09_desc: 'Inner Journey is a mental-health information and reflection assistant that helps clarify emotions, stress, and relationship concerns; it does not diagnose or replace qualified human support.',
        astras_official_editor_10_name: 'Mindful Guide',
        astras_official_editor_10_desc: 'Mindful Guide is a mental-health information and reflection assistant that helps you understand emotional and behavioral patterns; it does not provide diagnosis, treatment, or professional services.',

const en = {
        ...
        authEmail: 'Email',
        authLoginCreateAccount: 'Log in / create account',
        authUseGoogleLogin: 'Continue with Google',
        authUseLegacyLocalLogin: 'Use legacy local login / import',
        authLegacyAccount: 'Legacy account / local name',
        authLegacyAccountPlaceholder: 'Enter a legacy account or new local name',
        authLegacyPasswordPlaceholder: 'Legacy password or new local password',
        authLocalLoginRegister: 'Log in / register local account',
        authConfirmImportLogin: 'Confirm import and sign in',
        authBackToCloudLogin: 'Back to Email / Google login',
        authOr: 'or',
        resetLoginPasswordTitle: 'Reset login password',
        newLoginPasswordPlaceholder: 'New login password (at least 8 characters)',
        confirmNewLoginPasswordPlaceholder: 'Enter the new password again',
        resetLoginPasswordButton: 'Reset password',
        authImportAfterCloudLoginConfirm: 'You are signed in. Import legacy local records now?',
        authImportToCloudNotice: 'Enter the legacy account and password, then press Import records. The imported data will be placed under the current cloud account.',
        authTurnstileLoadError: 'Security verification failed to load. Refresh and try again.',
        authTurnstileRequired: 'Complete the security verification first.',
        authSetNewPasswordPrompt: 'Set your new password.',
        authEmailPasswordRequired: 'Enter an Email and a password with at least 8 characters.',
        authSigningIn: 'Signing in. If the account does not exist, it will be created automatically.',
        authEmailConfirmationSent: 'Account created. Open the verification link in your inbox, then sign in again.',
        authPasswordResetEmailRequired: 'Enter the Email you want to reset the password for.',
        authPasswordResetEmailSent: 'Password reset email sent. Please check your inbox.',
        authCloudModeNotice: 'Switched back to Email / Google login.',
        authLocalModeNotice: 'Enter the legacy account password; you can also import a legacy backup here.',
        authLocalImportRequired: 'Enter the legacy account password first, then press Import records.',
        authResetPasswordMismatch: 'Passwords must match and contain at least 8 characters.',
        authPasswordUpdated: 'Password updated. Sign in with the new password.',
        // Main App UI
        newChat: 'New Chat',

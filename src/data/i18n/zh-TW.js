const zhTW = {
        ...
        // Main App UI
        newChat: '新對話',
        temporaryChatStart: '開始臨時對話',
        temporaryChatExit: '退出臨時對話',
        temporaryChatTitle: '臨時對話',
        temporaryChatDescription: '此對話可以參考既有記憶，但不會顯示在你的對話記錄中，也不會產生新記憶。',
        temporaryChatPersonalized: '個人化',
        ...
        learning: '學習',
        image: '影像',
        cameraDescription: '使用裝置拍攝影像',
        imageDescription: '上傳圖片或影片',
        fileDescription: '上傳文件與其他檔案',
        webSearchDescription: '搜尋即時網路資訊',
        learningDescription: '以引導方式協助理解',
        modelCouncilDescription: '讓多個模型共同分析',
        learningMode: '學習',

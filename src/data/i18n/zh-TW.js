const zhTW = {
        ...
        naming: 'AI思考中...',
        thinkingStatus: '正在思考…',
        councilPreparationGroup: '轉譯與搜尋',
        councilModelStatusGroup: '模型狀態',
        councilDocumentTranslation: '文件轉譯',
        councilWebSearch: '網路搜尋',
        councilSynthesizer: '統整',
        councilStatusWaiting: '等待中',
        councilStatusThinking: '思考中',
        councilStatusResponding: '回覆中',
        councilStatusDone: '已完成',
        councilStatusError: '發生錯誤',
        councilStatusInProgress: '進行中',
        searching: '正在搜尋中...',
        noMessages: '此對話沒有訊息。',

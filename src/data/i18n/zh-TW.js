const zhTW = {
        ...
        authImportAfterCloudLoginConfirm: '已登入，是否現在匯入舊版本機紀錄？',
        authImportToCloudNotice: '請輸入舊版帳號密碼，然後按「匯入紀錄」。匯入後資料會放到目前登入的雲端帳號底下。',
        authTurnstileLoadError: '安全驗證載入失敗，請重新整理後再試。',
        authTurnstileRequired: '請先完成人機驗證。',
        authSetNewPasswordPrompt: '請設定您的新密碼。',
        authEmailPasswordRequired: '請輸入 Email，密碼至少 8 個字元。',
        authSigningIn: '登入中；如果帳號不存在，會自動建立。',
        authEmailConfirmationSent: '帳號已建立，請到信箱點擊驗證連結後再登入。',
        authPasswordResetEmailRequired: '請先輸入要重設密碼的 Email。',
        authPasswordResetEmailSent: '密碼重設信已寄出，請查看信箱。',
        authCloudModeNotice: '已切回 Email / Google 登入。',
        authLocalModeNotice: '請輸入舊版帳號密碼；也可以在這裡匯入舊版備份。',
        authLocalImportRequired: '請先輸入舊版帳號密碼，再按「匯入紀錄」。',
        authResetPasswordMismatch: '兩次密碼需一致，且至少 8 個字元。',
        authPasswordUpdated: '密碼已更新，請用新密碼登入。',
        // Main App UI
        newChat: '新對話',
        batchSelect: '批次選取',

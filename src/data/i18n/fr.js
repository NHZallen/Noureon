const fr = {
        ...
        authEmail: 'Email',
        authLoginCreateAccount: 'Connexion / créer un compte',
        authUseGoogleLogin: 'Continuer avec Google',
        authUseLegacyLocalLogin: 'Connexion locale ancienne / importer',
        authLegacyAccount: 'Ancien compte / nom local',
        authLegacyAccountPlaceholder: 'Saisissez un ancien compte ou un nouveau nom local',
        authLegacyPasswordPlaceholder: 'Ancien mot de passe ou nouveau mot de passe local',
        authLocalLoginRegister: 'Connexion / créer un compte local',
        authConfirmImportLogin: 'Confirmer l’importation et se connecter',
        authBackToCloudLogin: 'Retour à la connexion Email / Google',
        authOr: 'ou',
        resetLoginPasswordTitle: 'Réinitialiser le mot de passe',
        newLoginPasswordPlaceholder: 'Nouveau mot de passe (8 caractères minimum)',
        confirmNewLoginPasswordPlaceholder: 'Saisissez à nouveau le nouveau mot de passe',
        resetLoginPasswordButton: 'Réinitialiser le mot de passe',
        authImportAfterCloudLoginConfirm: 'Vous êtes connecté. Importer maintenant les anciens enregistrements locaux ?',
        authImportToCloudNotice: 'Saisissez l’ancien compte et le mot de passe, puis appuyez sur Importer des données. Les données seront placées sous le compte cloud actuel.',
        authTurnstileLoadError: 'La vérification de sécurité n’a pas pu se charger. Actualisez puis réessayez.',
        authTurnstileRequired: 'Terminez d’abord la vérification de sécurité.',
        authSetNewPasswordPrompt: 'Définissez votre nouveau mot de passe.',
        authEmailPasswordRequired: 'Saisissez un Email et un mot de passe d’au moins 8 caractères.',
        authSigningIn: 'Connexion en cours. Si le compte n’existe pas, il sera créé automatiquement.',
        authEmailConfirmationSent: 'Compte créé. Ouvrez le lien de vérification dans votre boîte mail, puis reconnectez-vous.',
        authPasswordResetEmailRequired: 'Saisissez l’Email du mot de passe à réinitialiser.',
        authPasswordResetEmailSent: 'Email de réinitialisation envoyé. Vérifiez votre boîte mail.',
        authCloudModeNotice: 'Retour à la connexion Email / Google.',
        authLocalModeNotice: 'Saisissez le mot de passe de l’ancien compte ; vous pouvez aussi importer une sauvegarde ici.',
        authLocalImportRequired: 'Saisissez d’abord l’ancien compte et le mot de passe, puis appuyez sur Importer des données.',
        authResetPasswordMismatch: 'Les mots de passe doivent correspondre et contenir au moins 8 caractères.',
        authPasswordUpdated: 'Mot de passe mis à jour. Connectez-vous avec le nouveau mot de passe.',
        // Main App UI

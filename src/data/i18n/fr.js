const fr = {
        ...
        privacyPolicyDesc: "Noureon est local-first par défaut : conversations, paramètres, Nouras, dossiers, préférences d’apparence et clés API de fournisseurs sont stockés dans le navigateur, sauf si vous choisissez l’import/export ou si vous vous connectez et activez la synchronisation cloud. Lorsque la synchronisation cloud est activée, Supabase stocke les données nécessaires à la synchronisation multi-appareils, notamment conversations, dossiers, Nouras, messages, métadonnées de synchronisation, marqueurs de suppression et fichiers importés ou générés dans le stockage. Les coffres ou charges de récupération sensibles sont chiffrés avec votre clé/mot de passe de synchronisation lorsqu’ils sont configurés ; les clés API restent locales sauf inclusion ou synchronisation explicite via un flux chiffré pris en charge. Les e-mails d’authentification sont envoyés via Supabase/Resend, Turnstile peut être utilisé contre les abus, et le support passe par support@noureon.com. Les prompts, contextes, pièces jointes et options de modèle sont envoyés au fournisseur IA ou de recherche sélectionné. Noureon ne vend pas de données personnelles et ce dépôt n’inclut pas de suivi publicitaire intégré. Vous pouvez exporter, supprimer ou effacer les données locales depuis les paramètres ou le navigateur.",
        close: 'Fermer',
        show: 'Afficher',
        hide: 'Masquer',
        trash: 'Corbeille',

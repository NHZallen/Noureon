const fr = {
        ...
        passwordRecoveryPageTitle: 'Réinitialiser le mot de passe · Noureon',
        passwordResetPageTitle: 'Définir un nouveau mot de passe · Noureon',
        passwordRecoveryTitle: 'Réinitialiser votre mot de passe',
        passwordRecoveryDescription: 'Saisissez l’adresse Email liée à votre compte pour recevoir un code de vérification à 8 chiffres.',
        passwordRecoverySendCode: 'Envoyer le code',
        passwordRecoveryCodeSent: 'Si cette adresse Email est liée à un compte, un code a été envoyé. Vérifiez votre boîte de réception et vos indésirables.',
        passwordRecoveryCodeLabel: 'Code de vérification à 8 chiffres',
        passwordRecoveryVerifyCode: 'Vérifier et continuer',
        passwordRecoveryRequestAnother: 'Demander un nouveau code',
        passwordRecoveryResendCountdown: 'Renvoyer dans {seconds} s',
        passwordRecoveryBackToLogin: 'Retour à la connexion',
        passwordRecoveryEmailInvalid: 'Saisissez une adresse Email valide.',
        passwordRecoverySendFailed: 'Impossible d’envoyer un code pour le moment. Réessayez plus tard.',
        passwordRecoveryCodeInvalidFormat: 'Saisissez le code de vérification à 8 chiffres.',
        passwordRecoveryCodeInvalid: 'Le code est incorrect ou a expiré. Vérifiez-le et réessayez.',
        passwordResetChecking: 'Vérification en cours…',
        passwordResetVerificationRequiredTitle: 'Vérifiez d’abord votre Email',
        passwordResetVerificationRequired: 'Pour réinitialiser votre mot de passe, saisissez votre Email et vérifiez d’abord le code reçu.',
        passwordResetVerificationExpired: 'Cette vérification a expiré. Demandez un nouveau code.',
        passwordResetVerificationUnavailable: 'Impossible de confirmer cette vérification. Demandez un nouveau code.',
        passwordResetStart: 'Commencer la réinitialisation',
        passwordResetNewTitle: 'Définir un nouveau mot de passe',
        passwordResetNewDescription: 'Créez un nouveau mot de passe de connexion d’au moins 8 caractères.',
        passwordResetNewLabel: 'Nouveau mot de passe',
        ...
        passwordResetMismatchOnly: 'Les deux nouveaux mots de passe ne correspondent pas.',
        passwordResetUpdateFailed: 'Impossible de mettre à jour le mot de passe. Demandez un nouveau code et réessayez.',
        ...
        temporaryChatStart: 'Démarrer une discussion temporaire',
        temporaryChatExit: 'Quitter la discussion temporaire',
        temporaryChatTitle: 'Discussion temporaire',
        temporaryChatDescription: 'Cette discussion peut consulter les souvenirs existants, mais elle ne figurera pas dans votre historique et ne créera aucun nouveau souvenir.',
        temporaryChatPersonalized: 'Personnalisée',
        ...
        image: 'Image',
        cameraDescription: 'Prendre une image avec cet appareil',
        imageDescription: 'Importer des images ou des vidéos',
        fileDescription: 'Importer des documents et autres fichiers',
        webSearchDescription: 'Trouver des informations récentes en ligne',
        learningDescription: 'Apprendre avec des explications guidées',
        modelCouncilDescription: 'Analyser avec plusieurs modèles',
        ...
        dialogInputPlaceholder: 'Saisissez ici…',
        historyRecallTitle: 'Rappel inter-conversations',
        historyRecallDescription: 'Une fois activé, cet appareil envoie la question actuelle à Gemini Embedding 2 et utilise un index local pour trouver jusqu’à trois résumés pertinents d’anciennes conversations. Les sources ne sont pas affichées dans le chat.',
        historyRecallBuildIndex: 'Créer l’index local complet',
        historyRecallAuditIndex: 'Vérifier l’index local',
        ...
        historyRecallStatusLoading: 'Chargement de l’index local de cet appareil…',
        historyRecallProgress: '{completed}/{total} conversations analysées ({percentage} %)',
        historyRecallStatusBuilding: 'Vérification de l’index local : {completed}/{total} conversations analysées. Les éléments manquants ou obsolètes sont réparés automatiquement.',
        historyRecallStatusComplete: 'Vérification terminée : {completed}/{total} conversations analysées ({indexed} réparées, {skipped} déjà à jour, {failed} échecs).',
        historyRecallStatusIncomplete: 'Vérification incomplète : {completed}/{total} conversations analysées ({indexed} réparées, {skipped} déjà à jour, {failed} échecs).',
        ...
        exportApiKeysPasswordTitle: 'Déverrouiller l’export des clés API',
        exportApiKeysPasswordPrompt: 'Saisissez votre mot de passe de synchronisation pour chiffrer les clés API de cette sauvegarde.',
        importApiKeysPasswordTitle: 'Déverrouiller les clés API',
        importApiKeysPasswordPrompt: 'Saisissez le mot de passe de synchronisation utilisé lors de la création de cette sauvegarde.',
        ...
        highRiskNourasWarning: 'Ce Nouras peut concerner un rôle professionnel à haut risque en santé mentale, médecine, droit ou finance. Noureon ne vérifie pas ses qualifications ; il ne peut fournir que des informations générales et une aide à l\'organisation, sans remplacer une aide humaine qualifiée.',
        ...
        voiceErrorNotAllowed: 'L’accès au microphone a été refusé. Autorisez ce site à utiliser votre microphone dans les paramètres du navigateur, puis réessayez.',
        voiceErrorNoSpeech: 'Aucune parole détectée. Réessayez de parler ou utilisez le clavier.',
        voiceErrorAborted: 'Saisie vocale annulée.',
        voiceErrorAudioCapture: 'Aucun microphone détecté. Vérifiez qu’un microphone est connecté.',
        voiceErrorNetwork: 'Le service de reconnaissance vocale est injoignable. Vérifiez votre connexion et réessayez.',
        voiceErrorLanguageUnsupported: 'Votre navigateur ne prend pas en charge la reconnaissance vocale pour la langue d’interface actuelle. La saisie au clavier et la recherche restent disponibles.',
        voicePrivacyNoticeTitle: 'À propos de la saisie vocale',
        voicePrivacyNoticeBody: 'La saisie vocale est transcrite par votre navigateur, qui peut transmettre l’audio à votre système d’exploitation ou à un service vocal en ligne. Noureon ne conserve aucun enregistrement séparé. Commencer ?',
        ...
        astras_official_editor_09_desc: 'Voyage Intérieur est un assistant d\'information et de réflexion sur la santé mentale, qui aide à clarifier émotions, stress et difficultés relationnelles ; il ne diagnostique pas et ne remplace pas une aide humaine qualifiée.',
        astras_official_editor_10_name: 'Guide Conscient',
        astras_official_editor_10_desc: 'Guide Conscient est un assistant d\'information et de réflexion sur la santé mentale qui aide à comprendre les schémas émotionnels et comportementaux ; il ne fournit ni diagnostic, ni traitement, ni service professionnel.',
